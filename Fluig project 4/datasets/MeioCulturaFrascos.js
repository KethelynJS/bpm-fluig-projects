...
function createDataset(fields, constraints, sortFields) {
    var colunas = [
        ...
        'lote', 'metadata#active', 'opcao', 'prioridade', 'respc', 'numeroSolicitacao' , 'lotereagente'
    ];

    // Obtém os dados do dataset original
    var dataset = DatasetFactory.getDataset('DSRegistrodeanalises-Meiodeculturafrascos', colunas, constraints, null);
