function defineStructure() {
    ...
    addColumn('question8');
    addColumn('question9');
    addColumn('question10');
    addColumn('question11');
    addColumn('Resultado');
    addColumn('lote_reagente');
...
function createDataset(fields, constraints, sortFields) {
    var colunas = [
        'numeroSolicitacao', 'data_inicio', 'opcao', 'lote', 'question6', 'question7', 'question8', 'companyid',
        'question9', 'question10', 'question11', 'Resultado', 'lote_reagente', 'responsavel', 'prioridade', 'aprovado',
        'datacalendario', 'Resp', 'metadata#active'
    ];

    // Obtém os dados do dataset original
    var dataset = DatasetFactory.getDataset('DSRegistrodeanalises-alcaseagulhas', colunas, constraints, null);
