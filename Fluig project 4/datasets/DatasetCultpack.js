...
function createDataset(fields, constraints, sortFields) {
    var colunas = [
        'numeroSolicitacao', 'opcao', 'lote', 'aspecto', 'Resultado', 'responsavel', 'companyid',
        'prioridade', 'aprovado', 'datacalendario', 'Resp', 'metadata#active'
    ];

    // Obtém os dados do dataset original
    var dataset = DatasetFactory.getDataset('DSRegistrodeanalises-Cultpack', colunas, constraints, null);
