$(document).ready(function() {
    var produtoData = {
        'PA154	Egg Yolk com Telurito frasco c/ 100mL	PA - Suplementos MC': {
        ...
        'PA155	Egg Yolk sem Telurito frasco c/ 100mL	PA - Suplementos MC': {
            aspecto: 'Aspecto final -  Especificação: Suspensão líquida com densidade característica e cor amarela opaca. Resultado: Adequado',
            dosagem: ' g/200 mL',
            bacteriana: true,
            infoText1:'Desempenho microbiológico S. aureus ATCC 25923 -  Especificação:  Crescimento excelente de colônias brancas com halo de lecitinase. Resultado: Adequado Desempenho microbiológico S. epidermidis ATCC 12228 -  Especificação:  Crescimento excelente de colônias brancas sem halo de lecitinase. Resultado: Adequado '
        },
        'PU49 - Solução de hidróxido de sódio 1N estéril frasco c/ 50 mL': {
            aspecto: 'Aspecto final Especificação: Solução incolor, límpida, sem precipitados. Resultado: Adequado',
            dosagem: ' g/200 mL',
            bacteriana: true,
            infoText1:'NA'
        },
        'PU64 - Água Purificada Estéril Frasco c/ 10mL': {
            aspecto: 'Aspecto final Especificação: Solução incolor, límpida, sem precipitados. Resultado: Adequado',
            dosagem: ' g/200 mL',
            bacteriana: true,
            infoText1:'NA'
        },
        'PU76 - Água Purificada Estéril Frasco c/ 100mL': {
            aspecto: 'Aspecto final Especificação: Solução incolor, límpida, sem precipitados. Resultado: Adequado',
            dosagem: ' g/200 mL',
            bacteriana: true,
            infoText1:'NA'
        },
        'PA158	Sangue de Carneiro Desfibrinado frasco c/ 50mL	PA - Suplementos MC': {
        ...
        'PI01	Sangue de Carneiro Desfibrinado frasco c/ 1800 mL - Termolábel	PI': {
            aspecto: 'Aspecto final. Especificação: Vermelho vivo, opalescente, homogêneo, sem sinais de hemólise e coagulação. Resultado: Adequado',
            dosagem: ' g/300 mL',
            bacteriana: true,
            infoText1: 'Desempenho Microbiológico E. coli ATCC 25922. Especifciação: Crescimento excelente de colônias grandes, acinzentadas e brilhantes. Resultado: Adequado Desempenho Microbiológico S. aureus ATCC 25923. Especifciação: Crescimento excelente de colônias grandes, amareladas e opacas.  Resultado: Adequado Desempenho Microbiológico S. pneumoniae ATCC 49619. Especificação: Crescimento moderado a bom de colônias pequenas Alfa hemolíticas.  Resultado: Adequado Desempenho Microbiológico S. pyogenes ATCC 19615. Especifciação: Crescimento moderado a bom de colônias pequenas Beta hemolíticas. Resultado: Adequado'
        },
        'PI02	Sangue de Carneiro Desfibrinado frasco c/ 220mL - Termolábel	PI': {
            aspecto: 'Aspecto final. Especificação: Vermelho vivo, opalescente, homogêneo, sem sinais de hemólise e coagulação. Resultado: Adequado',
            bacteriana: 'conforme',
            infoText1: 'Desempenho Microbiológico E. coli ATCC 25922. Especifciação: Crescimento excelente de colônias grandes, acinzentadas e brilhantes. Resultado: Adequado Desempenho Microbiológico S. aureus ATCC 25923. Especifciação: Crescimento excelente de colônias grandes, amareladas e opacas.  Resultado: Adequado Desempenho Microbiológico S. pneumoniae ATCC 49619. Especifciação: Crescimento moderado a bom de colônias pequenas Alfa hemolíticas.  Resultado: Adequado Desempenho Microbiológico S. pyogenes ATCC 19615. Especifciação: Crescimento moderado a bom de colônias pequenas Beta hemolíticas. Resultado: Adequado'
        },
        
        'PI107	Sangue de Cavalo Frasco c/ 500mL - Termolábel	PI': {
            aspecto: 'Aspecto final. Especificação: Vermelho vivo, opalescente, homogêneo, sem sinais de hemólise e coagulação. Resultado: Adequado',
            bacteriana: 'conforme',
            infoText1: 'Desempenho Microbiológico S. pneumoniae ATCC 49619. Especifciação: Crescimento moderado a bom de colônias pequenas Alfa hemolíticas.  Resultado: Adequado Desempenho microbiológico H. influenzae ATCC 10211.  Especificação: Crescimento moderado a bom de colônias médias translúcidas. Resultado: Adequado'
        },
        'PA159': {
            ...
            bacteriana: 'conforme',
            infoText1: 'Desempenho microbiológico N. meningitidis ATCC 13090. Especificação: Crescimento moderado a bom de colônias pequenas translúcidas. Resultado: Adequado Desempenho microbiológico H. influenzae ATCC 10211.  Especificação: Crescimento moderado a bom de colônias médias translúcidas. Resultado: Adequado'
        },
        'PI81	Suplemento VX solução A - avulso - Termolábel	PI': {
            aspecto: 'Aspecto final Solução A. Especificação: Pó compacto levemente rosado. Resultado: Adequado ',
            bacteriana: 'conforme',
            infoText1: 'Desempenho microbiológico N. meningitidis ATCC 13090. Especificação: Crescimento moderado a bom de colônias pequenas translúcidas. Resultado: Adequado Desempenho microbiológico H. influenzae ATCC 10211.  Especificação: Crescimento moderado a bom de colônias médias translúcidas. Resultado: Adequado'
        },
        'PI82	Suplemento VX solução B - avulso - Termolábel	PI': {
            aspecto: 'Aspecto final Solução B. Especificação: Líquido incolor transparente, sem precipitado visível. Resultado: Adequado',
            bacteriana: 'conforme',
            infoText1: 'Desempenho microbiológico N. meningitidis ATCC 13090. Especificação: Crescimento moderado a bom de colônias pequenas translúcidas. Resultado: Adequado Desempenho microbiológico H. influenzae ATCC 10211.  Especificação: Crescimento moderado a bom de colônias médias translúcidas. Resultado: Adequado'
        },
        'PI23	Suplemento VX frasco c/ 40 mL	PI': {
            aspecto: 'Aspecto final  Especificação: Liquido rosa claro, sem precipitados significativo. Resultado: Adequado',
            bacteriana: 'conforme',
            infoText1: 'Desempenho microbiológico N. meningitidis ATCC 13090. Especificação: Crescimento moderado a bom de colônias pequenas translúcidas. Resultado: Adequado Desempenho microbiológico H. influenzae ATCC 10211.  Especificação: Crescimento moderado a bom de colônias médias translúcidas. Resultado: Adequado'
        },
        'PI104	Suplemento VX frasco c/ 275mL	PI': {
            aspecto: 'Aspecto final  Especificação: Liquido rosa claro, sem precipitados significativo. Resultado: Adequado',
            bacteriana: 'conforme',
            infoText1: 'Desempenho microbiológico N. meningitidis ATCC 13090. Especificação: Crescimento moderado a bom de colônias pequenas translúcidas. Resultado: Adequado Desempenho microbiológico H. influenzae ATCC 10211.  Especificação: Crescimento moderado a bom de colônias médias translúcidas. Resultado: Adequado'
        },
        'PI20	Substrato com uréia frasco c/ 70 mL - Termolábel	PI': {
            aspecto: 'Aspecto final Especificação: Solução âmbar clara, límpida, sem precipitados. Resultado: Adequado',
            bacteriana: 'conforme',
        ...
        'PI21	Substrato para rugai frasco c/ 175 mL - Termolábel	PI': {
            aspecto: 'Aspecto final Especificação: Solução âmbar clara, límpida, sem precipitados. Resultado: Adequado',
            bacteriana: 'conforme',
            infoText1: 'Desempenho microbiológico P. vulgaris ATCC 13315 - Especificação: LTD +; Glicose +; Gás +; H2S +; URE +; LIS -; MOT +; IND +. Resultado: Adequado Desempenho microbiológico K. pneumoniae ATCC 13883 - Especificação: LTD -; Glicose +; Gás +; H2S -; URE +; LIS +; MOT -; IND -. Resultado: Adequado Desempenho microbiológico E. coli ATCC 25922 - Especificação: LTD -; Glicose +; Gás +; H2S -; URE -; LIS +; MOT +; IND +. Resultado: Adequado Desempenho microbiológico P. aeruginosa ATCC 27853 - Especificação: TD -; Glicose -; Gás -; H2S -; URE -; LIS -; MOT +; IND -. Resultado: Adequado Desempenho microbiológico S. flexneri ATCC 12022 - Especificação: LTD -; Glicose +; Gás -; H2S -; URE -; LIS -; MOT -; IND -. Resultado: Adequado Desempenho microbiológico S. typhimurium ATCC 14028  - Especificação: LTD -; Glicose +; Gás +; H2S +; URE -; LIS +; MOT +; IND -.  Resultado: Adequado'
        },
        'PI22	Substrato sem uréia frasco c/ 35 mL - Termolábel	PI': {
            aspecto: 'Aspecto final Especificação: Solução âmbar clara, límpida, sem precipitados. Resultado: Adequado',
            bacteriana: 'conforme',
        ...
        'PI27	Cloridrato de vancomicina reconstituído frasco c/ 15 mL (150mg de vancomicina) - Termolábel	PI': {
            aspecto: 'Aspecto final Especificação: Solução incolor, límpida, sem precipitados. Resultado: Adequado',
            bacteriana: 'conforme',
            infoText1: 'N.A.'
        },
        'PI29	VCN frasco c/ 35 mL	PI': {
            aspecto: 'Aspecto final Especificação:  Líquido levemente amarelado e ligeiramente opalescente. Resultado: Adequado',
            bacteriana: 'conforme',
        ...
        'PI30	Acido nalidíxico 1% estéril frasco c/ 6 mL	PI': {
            aspecto: 'Aspecto final Especificação: Solução incolor, límpida, sem precipitados. Resultado: Adequado',
            bacteriana: 'conforme',
        ...
        'PI31	Disco indicador de umidade estéril	PI': {
            aspecto: 'Aspecto final Especificação: Disco de coloração azul-clara. Resultado: Adequado',
            bacteriana: 'conforme',
            infoText1: 'N.A.'
        },
        'PI124	Fluconazol 2mg frasco c/ 100 mL - Termolábel	PI': {
            aspecto: 'Aspecto final Especificação: Solução incolor, límpida, sem precipitados. Resultado: Adequado',
            bacteriana: 'conforme',
            infoText1: 'N.A.'
        },
        ...
        'PU60 - Solução de Ácido Clorídrico 5N estéril frasco c/ 100mL': {
            aspecto: 'Aspecto final Especificação: Solução incolor, límpida, sem precipitados. Resultado: Adequado.',
            bacteriana: 'conforme',
            infoText1: 'N.A.'
        },
