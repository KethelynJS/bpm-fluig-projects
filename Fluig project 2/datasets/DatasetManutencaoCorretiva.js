...
function createDataset(fields, constraints, sortFields) {
    var colunas = [
        'numeroSolicitacao', 'datacalendario', 'solicitante', 'setor', 'equipamento_modelo', 'n_equipamento', 'companyid',
        'ocorrencia', 'interno_externo', 'descrever_acao', 'validar', 'metadata#active'
    ];

    // Obtém os dados do dataset original
    var dataset = DatasetFactory.getDataset('DSFormulariodeManutencaocorretivadeequipamentos_1709213597066', colunas, constraints, null);
