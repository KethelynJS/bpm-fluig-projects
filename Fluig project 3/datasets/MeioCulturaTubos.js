...
function createDataset(fields, constraints, sortFields) {
    var colunas = [
        ...
        'lote', 'metadata#active', 'opcao', 'prioridade', 'respc', 'numeroSolicitacao'
    ];

    // Obtém os dados do dataset original
    var dataset = DatasetFactory.getDataset('DSRegistrodeanalises-MeiodeCulturaTubos', colunas, constraints, null);
