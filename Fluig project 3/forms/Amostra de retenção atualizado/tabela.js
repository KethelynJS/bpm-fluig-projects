...
function addNewRecord() {
    ...
    const cells = [
        `<input type="text" id="codigo_${index}" name="codigo_${index}" class="form-control col-md-6">`,
        `<input type="text" id="lote_${index}" name="lote_${index}" class="form-control col-md-6">`,
...
function loadTableData() {
    ...
    data.forEach((item, index) => {
        ...
        newRow.insertCell(0).innerHTML = `<input type="text" id="codigo_${index}" name="codigo_${index}" class="form-control col-md-6" value="${item.codigo || ''}">`;
        newRow.insertCell(1).innerHTML = `<input type="text" id="lote_${index}" name="lote_${index}" class="form-control col-md-6" value="${item.lote || ''}">`;
        newRow.insertCell(2).innerHTML = '<button type="button" onclick="removeRow(this)">Remover</button>';
    });
...
function loadTableData3() {
    ...
    data.forEach((item, index) => {
        ...
        newRow.insertCell(4).innerHTML = '<button type="button" onclick="removeRow5(this)"><i class="flaticon flaticon-trash icon-md" aria-hidden="true"></i></button>';
    });
