...
function addNewRecord() {
    ...
    const cells = [
    	 `<textarea id="codigo_${index}" name="codigo_${index}" class="form-control col-md-3"></textarea>`,
         `<textarea id="lote_${index}" name="lote_${index}" class="form-control col-md-3"></textarea>`,
         ...
         `<textarea id="datavalidade_${index}" name="datavalidade_${index}" class="form-control col-md-2"></textarea>`,
...
function loadTableData() {
    ...
    data.forEach((item, index) => {
        ...
        newRow.insertCell(0).innerHTML = `<textarea id="codigo_${index}" name="codigo_${index}" class="form-control col-md-3">${item.codigo || ''}</textarea>`;
        newRow.insertCell(1).innerHTML = `<textarea id="lote_${index}" name="lote_${index}" class="form-control col-md-3">${item.lote || ''}</textarea>`;
        ...
        newRow.insertCell(4).innerHTML = `<textarea id="datavalidade_${index}" name="datavalidade_${index}" class="form-control col-md-2">${item.datavalidade || ''}</textarea>`;
