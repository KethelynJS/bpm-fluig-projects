function defineStructure() {
    ...
    addColumn('lote_reagende');
    addColumn('Resp4');
    addColumn('datacafinall');
    addColumn('opcao');
    addColumn('Respk');
...
function createDataset(fields, constraints, sortFields) {
    var colunas = [
        'numeroSolicitacao', 'opcao7','lote', 'aspecto', 'Resp', 'dosagem', 'companyid',
        'datainicio2', 'lote_reagende', 'Resp4', 'datacafinall', 'opcao', 'Respk', 'prioridade', 'aprovado',
        'datacalendario', 'Respp1'
    ];

    // Obtém os dados do dataset original
    var dataset = DatasetFactory.getDataset('DSRegistrodeAnalises-ControledequalidadeGLUCUP-LACTUPLIQUIDO', colunas, constraints, null);
